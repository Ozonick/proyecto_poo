...
public class AgregarUsuario extends JFrame {
	...
	public AgregarUsuario(ControladorPadre controlador) {
		...
		cbxTipoUsuario.setModel(new DefaultComboBoxModel(new String[] {"Selecciona un tipo"}));
		...
		cbxGenero.setModel(new DefaultComboBoxModel(new String[] {"Selecciona un genero"}));
		...
		cbxPregunta.setModel(new DefaultComboBoxModel(new String[] {"Selecciona una pregunta", "\u00BFalo plicia?"}));
		...
		cbxProvincia.setModel(new DefaultComboBoxModel(new String[] {"Selecciona una provincia"}));
		...
		cbxLocalidad.setModel(new DefaultComboBoxModel(new String[] {"Selecciona una localidad"}));
